...
Определяет язык админки.

Варианты:

* `"ru"` — админка всегда на русском;
* `"en"` — админка всегда на английском;
* `"public"` — админка берёт текущий язык публичного сайта.

Сейчас используется `"ru"`, чтобы админка не смешивала русский и английский, если на публичном сайте выбран английский язык.
