    ...
    <main style={{ display: "grid", gap: "24px" }}>
      ...
      >
        ...
        <ul style={{ margin: 0, paddingLeft: "20px", display: "grid", gap: "10px" }}>
          <li>
            <strong>Пришла новая заявка с сайта:</strong> открой раздел
            «Заявки», проверь данные, при необходимости создай клиента или
            привяжи заявку к существующему клиенту.
          </li>
          <li>
            <strong>Нужно назначить новую сессию:</strong> открой раздел
            «Сессии», выбери клиента, услугу, дату и время, затем сохрани запись.
          </li>
          <li>
      ...
      >
        ...
        <ul style={{ margin: 0, paddingLeft: "20px", display: "grid", gap: "8px" }}>
          <li>
            Для входа в админку нужен пароль администратора.
          </li>
          <li>
